...
using XAFUnifiedProject.Blazor.Server.Services;

namespace XAFUnifiedProject.Blazor.Server {
    public partial class XAFUnifiedProjectBlazorApplication : BlazorApplication {
        public XAFUnifiedProjectBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XAFUnifiedProjectBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
