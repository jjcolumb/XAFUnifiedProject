...
namespace XAFUnifiedProject.Web {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
    public partial class XAFUnifiedProjectAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private XAFUnifiedProject.Module.XAFUnifiedProjectModule module3;
        private XAFUnifiedProject.Module.Web.XAFUnifiedProjectAspNetModule module4;
        ...
        public XAFUnifiedProjectAspNetApplication() {
            InitializeComponent();
        }
        ...
        private void XAFUnifiedProjectAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
